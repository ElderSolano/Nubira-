      ...
      <table class="table table-sm">
        <thead>
          <tr>
            ...
            <th>Número de Teléfono de Contacto</th>
            <th>Acciones</th>
          </tr>
        </thead>
        <tbody>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title">{{ proveedorSeleccionado ? 'Editar Proveedor' : 'Crear Nuevo Proveedor' }}</h5>
            ...
            <div class="modal-body">
              <form @submit.prevent="guardarEdicion">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="rtn" v-model="proveedorSeleccionado.rtn" required>
                </div>
                <div class="form-group">
                  <label for="nombre">Nombre</label>
                  <input type="text" class="form-control" id="nombre" v-model="proveedorSeleccionado.nombre" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="nombre_contacto" v-model="proveedorSeleccionado.nombre_contacto" required>
                </div>
                <div class="form-group">
                  <label for="email_contacto">Email de Contacto</label>
                  <input type="email" class="form-control" id="email_contacto" v-model="proveedorSeleccionado.email_contacto" required>
                </div>
                <div class="form-group">
                  <label for="telefono_contacto">Número de Teléfono de Contacto</label>
                  <input type="text" class="form-control" id="telefono_contacto" v-model="proveedorSeleccionado.telefono_contacto" required>
                </div>
      ...
      async guardarEdicion() {
        try {
          if (this.proveedorSeleccionado.id) {
            ...
            await axios.post(this.apiUrl, this.proveedorSeleccionado);
          }
          this.obtenerProveedores();
          this.cerrarModal();
        } catch (error) {
